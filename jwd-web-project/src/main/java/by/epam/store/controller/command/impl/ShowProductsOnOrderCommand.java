...
/**
 * The command is responsible for search products on order
 * 
 * @author Mariya Kuksar
 * @see Command
 */
public class ShowProductsOnOrderCommand implements Command {
	...
	public Router execute(HttpServletRequest request) {
		...
		try {
			ProductList productList = catalogService.takeProductsOnOrder(page);
			...
			request.setAttribute(ParameterAndAttribute.TITLE, MessageKey.TITLE_PRODUCTS_ON_ORDER);
			session.setAttribute(ParameterAndAttribute.CURRENT_PAGE, PagePath.SHOW_PRODUCTS_ON_ORDER);
